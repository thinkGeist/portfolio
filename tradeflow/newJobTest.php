...
<link href="css/menustyle.css" rel="stylesheet" type="text/css" />
  ...
  <script type="text/javascript" src="js/buttonadd.js"></script>
...
$hours[] = $_POST['employeeHours[]'];
$completed = $_POST['completed'];
//$query = "INSERT INTO `po_1010101010` (`Job Name`, `Date`, `Address`, `phone`, `description`, `materials`, `completed`) VALUES ('$jobname',' $date',' $address', '$phone', '$description', '$materials', '$completed')";
...
<div class="input_fields_wrap">
    ...
    <div><label>Employee Name:<input class="smallblueinput" type="text" name="employeeName[]">
    <label>Hours: <input class="numberinput"  type="text" name="employeehours[]"></div>
</div>
